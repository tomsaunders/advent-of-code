...
var Cave = /** @class */ (function () {
    function Cave(depth, targetX, targetY) {
        ...
        this.cells = [];
        var risk = 0;
        for (var y = 0; y <= targetY + 5; y++) {
            this.cells.push([]);
            for (var x = 0; x <= targetX + 5; x++) {
...
var MoveSet = /** @class */ (function () {
    ...
    MoveSet.prototype.delete = function (value) {
        this.arr = this.arr.filter(function (move) { return !move.equals(value); });
        return this;
    };
...
var Path = /** @class */ (function () {
    ...
    Object.defineProperty(Path.prototype, "score", {
        get: function () {
            return this.arr.reduce(function (cost, move) { return cost + move.cost; }, 0);
        },
        enumerable: true,
        configurable: true
    });
